...
public final class FragmentHistoryBinding implements ViewBinding {
  ...
  private FragmentHistoryBinding(@NonNull ConstraintLayout rootView, @NonNull TextView history) {
  ...
  public static FragmentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHistoryBinding((ConstraintLayout) rootView, history);
    }
